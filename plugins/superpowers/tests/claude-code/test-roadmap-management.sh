...
assert_file_contains "$SKILL" "起草完整" "new-roadmap draft must use the format reference"
assert_file_contains "$SKILL" "不要自造" "Roadmap table formats cannot be invented"
